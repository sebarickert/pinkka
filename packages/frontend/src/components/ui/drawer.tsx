...
function DrawerOverlay({
  ...
  return (
    <DrawerPrimitive.Overlay
      ...
      className={cn(
        'data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 fixed inset-0 z-(--z-drawer) bg-black/50',
        className,
      )}
      {...props}
    />
  ...
  return (
    <DrawerPortal data-slot="drawer-portal">
      ...
      <DrawerPrimitive.Content
        ...
        className={cn(
          'group/drawer-content bg-background fixed z-(--z-drawer) flex h-auto flex-col',
  ...
  return (
    <div
      ...
      className={cn(
        ...
        'flex flex-col gap-2 pt-6 px-4 pb-4',
        'max-w-sm mx-auto',
        className,
      )}
      {...props}
